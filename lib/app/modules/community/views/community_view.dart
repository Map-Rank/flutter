    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Obx(() => !controller.searchField.value
              ? Text(
                  'Community',
        ...
        floatingActionButton:
            Obx(() => !controller.floatingActionButtonTapped.value
                ? FloatingActionButton(
                    child: const FaIcon(FontAwesomeIcons.add),
                    heroTag: null,
                    onPressed: () {
                      controller.floatingActionButtonTapped.value =
                          !controller.floatingActionButtonTapped.value;
                    })
                : Container(
                    child: Column(
                      ...
                      children: [
                        ...
                        FloatingActionButton.extended(
                                onPressed: () {
                                  controller.floatingActionButtonTapped.value =
                                      !controller
                                          .floatingActionButtonTapped.value;
                                },
                                heroTag: null,
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return Obx(() => PostCardWidget(
                                        ...
                                        content:
                                            controller.allPosts[index].content,
                                        zone: controller.allPosts[index].zone !=
                                                null
                                            ? controller
                                                .allPosts[index].zone['name']
                                            : '',
                                        publishedDate: controller
                                            .allPosts[index].publishedDate,
                                        postId:
                                            controller.allPosts[index].postId,
                                        commentCount: controller
                                            .allPosts[index].commentCount,
                                        likeCount: RxInt(
                                          controller.selectedPost.contains(
                                                      controller
                                                          .allPosts[index]) &&
                                                  controller.postSelectedIndex
                                                          .value ==
                                                      index &&
                                              ...
                                              ? controller.allPosts[index]
                                                      .likeCount -
                                                  1
                                              : controller.selectedPost.contains(controller
                                                          .allPosts[index]) &&
                                                      controller
                                                              .postSelectedIndex
                                                              .value ==
                                        ...
                                        shareCount: controller
                                            .allPosts[index].shareCount,
                                        images: controller
                                            .allPosts[index].imagesUrl,
                                        user: User(
                                            firstName: controller
                                                .allPosts[index].user.firstName,
                                            lastName: controller
                                                .allPosts[index].user.lastName,
                                        ...
                                        onLikeTapped: () {
                                          controller.postSelectedIndex.value =
                                              index;

                                          if (controller.selectedPost.contains(
                                              controller.allPosts[index])) {
                                            controller.selectedPost.remove(
                                                controller.allPosts[index]);
                                            controller.postSelectedIndex.value =
                                                index;
                                            controller.likeUnlikePost(controller
                                                .allPosts[index].postId);
                                          } else {
                                            controller.selectedPost.add(
                                                controller.allPosts[index]);
                                            controller.postSelectedIndex.value =
                                                index;
                                            controller.likeUnlikePost(controller
                                        ...
                                        onCommentTapped: () async {
                                          controller.postDetails =
                                              await controller.getAPost(
                                                  controller
                                                      .allPosts[index].postId);
                                          controller.commentList.value =
                                              controller
                                        ...
                                        onSharedTapped: () async {
                                          await controller.sharePost(controller
                                              .allPosts[index].postId);
                                        },
                                        popUpWidget: controller.allPosts[index]
                                                    .user.userId ==
                                                controller
                                            ...
                                            ? PopupMenuButton(
                                                onSelected: (value) async {
                                                  ...
                                                  if (value == 'Edit') {
                                                    ...
                                                    controller.post =
                                                        await controller
                                                            .getAPost(controller
                                                                ...
                                                                .postId);
                                                    print(
                                                        'sectors ${controller.post.sectors!}');
                                                    ...
                                                    print(
                                                        'sectors selected : ${controller.sectorsSelected}');

                                                    controller.noFilter.value =
                                                        true;
                                                    Get.toNamed(
                                                        Routes.CREATE_POST);
                                                  }
