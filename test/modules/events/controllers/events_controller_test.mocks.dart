...
class MockEventsRepository extends _i1.Mock implements _i6.EventsRepository {
  ...
  @override
  _i5.Future<dynamic> getAllEvents(int? page) => (super.noSuchMethod(
        Invocation.method(
          #getAllEvents,
          [page],
        ),
...
class MockUserRepository extends _i1.Mock implements _i8.UserRepository {
  ...
  @override
  _i5.Future<_i4.UserModel> register(_i4.UserModel? user) =>
      (super.noSuchMethod(
        Invocation.method(
          #register,
          [user],
        ),
        returnValue: _i5.Future<_i4.UserModel>.value(_FakeUserModel_3(
          this,
          Invocation.method(
            #register,
            [user],
